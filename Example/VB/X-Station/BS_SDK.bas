...
Public Type XSUserhdr
    ...
    userName(DS_MAX_NAME_LEN - 1) As Integer
    department(DS_MAX_NAME_LEN - 1) As Integer
    password(DS_MAX_PASSWORD_LEN - 1) As Integer

    numOfFinger As Integer
    numOfFace As Integer
    duress(MAX_FINGER - 1) As Byte
    reserved(1) As Byte
    fingerType(MAX_FINGER - 1) As Byte
    reserved1(1) As Byte
    fingerChecksum(MAX_FINGER - 1) As Long
    faceChecksum(MAX_FACE_TEMPLATE - 1) As Long
...
Type XSOPModeConfig
    ...
    tnaMode As Byte
    cardMode As Byte
    authSchedule(1) As Byte
    reserved2(3) As Byte
    dualSchedule As Byte
    usePrivateAuthMode As Byte
    cardIdFormatType As Byte

    cardIdByteOrder As Byte
    cardIdBitOrder As Byte
    reserved3(2) As Byte
    useDetectFace As Byte
    useServerMatching As Byte
    matchTimeout As Byte
    reserved(79) As Byte
End Type
...
Public Declare Function BS_GetDeviceID Lib "BS_SDK" (ByVal handle As Long, ByRef biostationID As Long, ByRef deviceType As Long) As Long
Public Declare Function BS_SetDeviceID Lib "BS_SDK" (ByVal handle As Long, ByVal biostationID As Long, ByVal deviceType As Long) As Long
...
Public Declare Function BS_ReadLogEx Lib "BS_SDK" (ByVal handle As Long, ByVal startTime As Long, ByVal endTime As Long, ByRef numOfLog As Long, ByRef logRecord As BSLogRecordEx) As Long
Public Declare Function BS_ReadNextLog Lib "BS_SDK" (ByVal handle As Long, ByVal startTime As Long, ByVal endTime As Long, ByRef numOfLog As Long, ByRef logRecord As BSLogRecord) As Long
Public Declare Function BS_ReadNextLogEx Lib "BS_SDK" (ByVal handle As Long, ByVal startTime As Long, ByVal endTime As Long, ByRef numOfLog As Long, ByRef logRecord As BSLogRecordEx) As Long
...
Public Declare Function BS_ConvertToUTF8 Lib "BS_SDK" (ByVal msg As String, ByRef utf8Msg As Any, ByVal limitLen As Long) As Long
Public Declare Function BS_ConvertToUTF16 Lib "BS_SDK" (ByVal msg As String, ByRef utf16Msg As Any, ByVal limitLen As Long) As Long
...
'X-Station
Public Declare Function BS_EnrollUserXStation Lib "BS_SDK" (ByVal handle As Long, ByRef hdr As XSUserhdr) As Long
Public Declare Function BS_EnrollMultipleUserXStation Lib "BS_SDK" (ByVal handle As Long, ByVal numOfUser, ByRef hdr As XSUserhdr) As Long
Public Declare Function BS_GetAllUserInfoXStation Lib "BS_SDK" (ByVal handle As Long, ByRef hdr As XSUserhdr, ByRef numOfUser As Long) As Long
Public Declare Function BS_GetUserInfoXStation Lib "BS_SDK" (ByVal handle As Long, ByVal userID As Long, ByRef hdr As XSUserhdr) As Long
Public Declare Function BS_GetUserXStation Lib "BS_SDK" (ByVal handle As Long, ByVal userID As Long, ByRef hdr As XSUserhdr) As Long

Public Declare Function BS_WriteXSOPModeConfig Lib "BS_SDK" (ByVal handle As Long, ByRef config As XSOPModeConfig) As Long
Public Declare Function BS_ReadXSOPModeConfig Lib "BS_SDK" (ByVal handle As Long, ByRef config As XSOPModeConfig) As Long

Public Declare Function BS_SendNotice Lib "BS_SDK" (ByVal handle As Long, ByVal msg As String) As Long
Public Declare Function BS_SendNoticeEx Lib "BS_SDK" (ByVal handle As Long, ByVal msg As String, ByVal bUTF16 As Byte) As Long

Public Declare Function BS_DeleteSlideShow Lib "BS_SDK" (ByVal handle As Long) As Long
Public Declare Function BS_SetSlideShow Lib "BS_SDK" (ByVal handle As Long, ByVal numOfPicture As Long, ByVal imageIndex As Long, ByVal pngFile As String) As Long
