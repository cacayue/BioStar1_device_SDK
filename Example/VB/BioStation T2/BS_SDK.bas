...
Public Declare Function BS_EnrollUserBioStation2 Lib "BS_SDK" (ByVal handle As Long, ByRef userHdr As BS2UserHdr, ByRef fingerTemplate As Byte) As Long
Public Declare Function BS_EnrollMultipleUserBioStation2 Lib "BS_SDK" (ByVal handle As Long, ByVal numOfUser As Long, ByRef userHdr As BS2UserHdr, ByRef fingerTemplate As Byte) As Long
Public Declare Function BS_GetAllUserInfoBioStation2 Lib "BS_SDK" (ByVal handle As Long, ByRef userHdr As BS2UserHdr, ByRef numOfUser As Long) As Long
Public Declare Function BS_GetUserInfoBioStation2 Lib "BS_SDK" (ByVal handle As Long, ByVal userID As Long, ByRef userHdr As BS2UserHdr) As Long
Public Declare Function BS_GetUserBioStation2 Lib "BS_SDK" (ByVal handle As Long, ByVal userID As Long, ByRef userHdr As BS2UserHdr, ByRef fingerTemplate As Byte) As Long
