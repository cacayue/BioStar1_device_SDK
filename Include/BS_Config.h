...
#define BS_CONFIG_INTERPHONE		0x80
...
#define XS_CONFIG_PIN_ONLY_MODE     0x85
...
} DSInterphoneConfig, XSInterphoneConfig, BS2InterphoneConfig, FSInterphoneConfig;
...
typedef struct{
	...
	unsigned char useTemplateImage;		  // 0(Not use) ~ 1(Use), 1	
