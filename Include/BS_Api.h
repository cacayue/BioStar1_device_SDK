...
// UnInitialize SDK
// 
__declspec( dllexport ) BS_RET_CODE __stdcall BS_UnInitSDK();
...
__declspec( dllexport ) BS_RET_CODE __stdcall BS_ReadNextImageLog( int handle, time_t startTime, time_t endTime, int* numOfLog, UCHAR* imageLogData );
...
__declspec( dllexport ) BS_RET_CODE __stdcall BS_EnrollUserFStationEx( int handle, FSUserHdrEx* userHdr, unsigned char* imageData, unsigned char* faceTemplate);
...
__declspec( dllexport ) BS_RET_CODE __stdcall BS_EnrollMultipleUserFStationEx( int handle, int numOfUser, FSUserHdrEx* userHdr, unsigned char* imageData, unsigned char* faceTemplate);
__declspec( dllexport ) BS_RET_CODE __stdcall BS_GetAllUserInfoFStation( int handle, FSUserHdr* userHdr, int* numOfUser );
__declspec( dllexport ) BS_RET_CODE __stdcall BS_GetAllUserInfoFStationEx( int handle, FSUserHdrEx* userHdr, int* numOfUser );
__declspec( dllexport ) BS_RET_CODE __stdcall BS_GetUserInfoFStation( int handle, unsigned userID, FSUserHdr* userHdr );
__declspec( dllexport ) BS_RET_CODE __stdcall BS_GetUserInfoFStationEx( int handle, unsigned userID, FSUserHdrEx* userHdr );
...
__declspec( dllexport ) BS_RET_CODE __stdcall BS_GetUserFStationEx( int handle, unsigned userID, FSUserHdrEx* userHdr, unsigned char* imageData, unsigned char* faceTemplate);
...
__declspec( dllexport ) BS_RET_CODE __stdcall BS_WriteDSInterphoneConfig( int handle, DSInterphoneConfig* config );
__declspec( dllexport ) BS_RET_CODE __stdcall BS_ReadDSInterphoneConfig( int handle, DSInterphoneConfig* config );
...
__declspec( dllexport ) BS_RET_CODE __stdcall BS_WriteXSPINOnlyModeConfig( int handle, XSPINOnlyModeConfig* config );
__declspec( dllexport ) BS_RET_CODE __stdcall BS_ReadXSPINOnlyModeConfig( int handle, XSPINOnlyModeConfig* config );
__declspec( dllexport ) BS_RET_CODE __stdcall BS_WriteXSInterphoneConfig( int handle, XSInterphoneConfig* config );
__declspec( dllexport ) BS_RET_CODE __stdcall BS_ReadXSInterphoneConfig( int handle, XSInterphoneConfig* config );
...
__declspec( dllexport ) int __stdcall BS_UTF8ToString(const char *szUTF8, char *szOutput);
__declspec( dllexport ) int __stdcall BS_UTF16ToString(const char *szUTF16, char *szOutput);
__declspec( dllexport ) time_t __stdcall BS_ConvertToLocalTime( time_t utcTime );
__declspec( dllexport ) BS_RET_CODE __stdcall BS_EncryptSHA256( unsigned char *input, int length, unsigned char *output );
