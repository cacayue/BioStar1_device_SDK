...
#define BS_MAX_NUM_IMAGE_LOG 200
#define BS_MAX_LOGBULK_SIZE	1000 * 1024
#define BS_MAX_FACE_TYPE 5
...
#define BS_MAX_FACE_RAW_IMAGE 30
#define BS_RAW_IMAGE_SIZE (640 * 480)
...
typedef struct{
	...
	unsigned userID;
	unsigned short numOfFaceType;
	unsigned short numOfRawFace[MAX_FACE_TYPE];
	unsigned short rawfaceLen[MAX_FACE_TYPE][MAX_FACE_RAW];
} FSRawTemplateHdrEx;

typedef struct{	
	unsigned userID;	
	unsigned short numOfRawImage;	
	unsigned int rawImageLen[30];	
} FSRawImageHdr;		
