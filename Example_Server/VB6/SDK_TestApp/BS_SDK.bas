...
Type BSUserHdrEx
    ...
    authMode As Integer
    authLimitCount As Integer
    reserved As Integer
    timedAntiPassback As Integer
    cardID As Long
    bypassCard As Byte
    disabled As Byte
...
Public Declare Function BS_GetDeviceID Lib "BS_SDK" (ByVal handle As Long, ByRef biostationID As Long, ByRef devuceType As Long) As Long
Public Declare Function BS_SetDeviceID Lib "BS_SDK" (ByVal handle As Long, ByVal biostationID As Long, ByVal devuceType As Long) As Long
...
' VB.NET
'Public Delegate Function BS_ConnectionProc(ByVal handle As Long, ByVal deviceID As Long, ByVal deviceType As Long, ByVal connectionType As Long, ByVal functionType As Long, ByVal ipAddress As String) As Long
'Public Delegate Function BS_DisconnectedProc(ByVal handle As Long, ByVal deviceID As Long, ByVal deviceType As Long, ByVal connectionType As Long, ByVal functionType As Long, ByVal ipAddress As String) As Long
'public Delegate Function BS_RequestStartProc(ByVal handle As Long, ByVal deviceID As Long, ByVal deviceType As Long, ByVal connectionType As Long, ByVal functionType AS Long, ByVal ipAddress As String) As Long
'public Delegate Function BS_LogProc(ByVal handle As Long, ByVal deviceID As Long, ByVal deviceType As Long, ByVal connectionType As Long, ByVal data As Long) As Long
'public Delegate Function BS_ImageLogProc(ByVal handle As Long, ByVal deviceID As Long, ByVal deviceType As Long, ByVal connectionType As Long, ByRef data As Long, ByVal dataLen As Long) As Long
'public Delegate Function BS_RequestMatchingProc(ByVal handle As Long, ByVal deviceID As Long, ByVal deviceType As Long, ByVal connectionType As Long, ByVal matchingType As Long, ByVal ID As Long, ByVal templateData As String, ByRef userHdr As Long, ByRef isDuress As Long) As Long
'public Delegate Function BS_RequestUserInfoProc(ByVal handle As Long, ByVal deviceID As Long, ByVal deviceType As Long, ByVal connectionType As Long, ByVal idType As Long, ByVal ID As Long, ByVal customID As Long, ByVal userHdr As Long) As Long
...
Public Declare Function BS_SetConnectedCallback Lib "BS_SDK" (ByVal pFunc As Long, ByVal syncOp As Byte, ByVal autoResponse As Byte) As Long
Public Declare Function BS_SetDisconnectedCallback Lib "BS_SDK" (ByVal pFunc As Long, ByVal syncOp As Byte) As Long
Public Declare Function BS_SetRequestStartedCallback Lib "BS_SDK" (ByVal pFunc As Long, ByVal syncOp As Byte, ByVal autoResponse As Byte) As Long
Public Declare Function BS_SetLogCallback Lib "BS_SDK" (ByVal pFunc As Long, ByVal syncOp As Byte, ByVal autoResponse As Byte) As Long
Public Declare Function BS_SetImageLogCallback Lib "BS_SDK" (ByVal pFunc As Long, ByVal syncOp As Byte, ByVal autoResponse As Byte) As Long
Public Declare Function BS_SetRequestUserInfoCallback Lib "BS_SDK" (ByVal pFunc As Long, ByVal syncOp As Byte) As Long
Public Declare Function BS_SetRequestMatchingCallback Lib "BS_SDK" (ByVal pFunc As Long, ByVal syncOp As Byte) As Long
Public Declare Function BS_SetSynchronousOperation Lib "BS_SDK" (ByVal syncOp As Byte) As Long

Public Declare Function BS_IssueCertificate Lib "BS_SDK" (ByVal handle As Long, ByVal deviceID As Long) As Long
Public Declare Function BS_DeleteCertificate Lib "BS_SDK" (ByVal handle As Long) As Long
Public Declare Function BS_StartRequest Lib "BS_SDK" (ByVal handle As Long, ByVal deviceType As Long, ByVal port As Long) As Long
Public Declare Function BS_GetConnectedList Lib "BS_SDK" (ByRef deviceList As Long, ByRef count As Long) As Long
Public Declare Function BS_CloseConnection Lib "BS_SDK" (ByVal deviceID As Long) As Long
